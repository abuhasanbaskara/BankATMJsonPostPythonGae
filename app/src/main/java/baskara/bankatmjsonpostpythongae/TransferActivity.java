...
public class TransferActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    private EditText editTextTransfer;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonTransfer = (Button)findViewById(R.id.buttonSubmitTransfer);
        editTextTransfer = (EditText)findViewById(R.id.editTransferMoney);
        editTextUsername = (EditText)findViewById(R.id.editTransferUsername);
    ...
    private void transer() throws JSONException {
        String transferUsername = editTextUsername.getText().toString();
        String transferMoney = editTextTransfer.getText().toString();
        ...
        item.put("transferMoney", transferMoney);
        item.put("transferUsername", transferUsername);
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    url = new URL("http://192.168.11.5:8080/transferHandlerAndroid");
